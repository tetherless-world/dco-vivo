...
<#if submissionErrors?has_content>
    <section id="error-alert" role="alert">
        ...
        <#if lvf.submissionErrorExists(editSubmission, "uri")>
 	        Please enter an access URL.
        </#if>
        </p>
    </section>
</#if>

<h2 xmlns="http://www.w3.org/1999/html">Distribution Access URL</h2>
<form class="editForm customForm" id="addAccessURL" method="post" enctype="multipart/form-data" action="${submitUrl}">
