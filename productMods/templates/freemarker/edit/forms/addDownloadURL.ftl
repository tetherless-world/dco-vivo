...
<#--Retrieve certain edit configuration information. Are we creating a new foaf:Document or editing the existing one-->
...
<h2 xmlns="http://www.w3.org/1999/html">Distribution Download URL</h2>
<form class="editForm customForm" id="adddownloadURL" method="post" enctype="multipart/form-data" action="${submitUrl}">
