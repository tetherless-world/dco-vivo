 ...
 *
 */
public class AddDistributionToDatasetGenerator implements EditConfigurationGenerator {
	...
	private String template = "addDistributionToDataset.ftl";
    ...
    public EditConfigurationVTwo getEditConfiguration(VitroRequest vreq, HttpSession session) {
    	...
    	System.out.println("Calling the configuration generators");
	...
	private void prepareForUpdate(VitroRequest vreq, HttpSession session, EditConfigurationVTwo editConfiguration) {
    	...
    	System.out.println("The session is");
    	...
    	if(EditConfigurationUtils.isObjectProperty(EditConfigurationUtils.getPredicateUri(vreq), vreq)){
	    	...
	    	if(!isReplaceWithNew(vreq) && 
	    		...
	    		System.out.println("distribution to dataset gen");
