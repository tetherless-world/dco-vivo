...
//import edu.cornell.mannlib.vitro.webapp.edit.n3editing.configuration.preprocessors.AddAccessURLPreprocessor;
import edu.cornell.mannlib.vitro.webapp.edit.n3editing.configuration.validators.AntiXssValidation;
import edu.cornell.mannlib.vitro.webapp.utils.FrontEndEditingUtils;
import edu.cornell.mannlib.vitro.webapp.utils.FrontEndEditingUtils.EditMode;


public class DistributionAccessURLGenerator extends VivoBaseGenerator implements EditConfigurationGenerator {
    ...
    public DistributionAccessURLGenerator() {}
    ...
    public EditConfigurationVTwo getEditConfiguration(VitroRequest vreq, HttpSession session) throws Exception {
        ...
        // This tells the configuration which freemarker template file to use to generate the form. In our form we have only one text box for the accessURL.
        ...
        editConfiguration.addEditSubmissionPreprocessor(
                new AddAccessURLPreprocessor(editConfiguration));
        */
