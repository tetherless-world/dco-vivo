...
public class DatasetHasCreatorValidator implements N3ValidatorVTwo {

    private static String MISSING_FIRST_NAME_ERROR = "Must specify the creator's first name.";
    private static String MISSING_LAST_NAME_ERROR = "Must specify the creator's last name.";
