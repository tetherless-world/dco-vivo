...
public class AddMemberRoleToPersonGenerator extends AddRoleToPersonTwoStageGenerator {
    ...
    private static final String template = "addMemberRoleToPerson.ftl";
    private static final String VCLASS_URI = "http://xmlns.com/foaf/0.1/Organization";

    private static final String DCO = "http://info.deepcarbon.net/schema#";
